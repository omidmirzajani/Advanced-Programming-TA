...
namespace Exam1_cs
{
    public class TruckDriver : ILocatable, IPerson, IDriver,IComparable<TruckDriver>
    {
        ...
        {
            return $"{Firstname} {Lastname} has a {Color.Name.ToLower()} truck!";
        }
        ...
        {
            if (c.Distance(target) * 7200 > c.AccountBalance)
            {
            ...
            else
            {
                ...
                c.AccountBalance -= this.Distance(target) * 7200;
        ...
        public int CompareTo(TruckDriver other)
        {
